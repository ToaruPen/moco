...
解決する中心課題は、moco が「ちょっと確認します」と発話した後、処理が続いているのか、停止したのか、何を行っているのかが見えないことである。画面は内部思考を推測せず、Codex App Server と音声ランタイムから観測できる事実を継続的に表示する。
...
│ MOCO  ちょっと確認します。         │ 20:14:12 WORK  Web 検索を開始      │
